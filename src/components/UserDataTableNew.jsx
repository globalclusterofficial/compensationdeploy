...
function UserDataTableNew({
  ...
  function HandleViewPaymentProof() {
    if (deleteIndex !== null) {
      onDelete(deleteIndex);
      setConfirmDeletion(false);
      setDeleteIndex(null);
  ...
  function handleShowPaymentProof(user) {
    setShowDetail(true);
...
UserDataTableNew.propTypes = {
  ...
  viewPaymentProof: PropTypes.func,
};

export default UserDataTableNew;
