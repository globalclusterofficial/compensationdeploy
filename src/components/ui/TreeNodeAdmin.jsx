...
function TreeNodeAdmin({ root, members }) {
  ...
  const rootNode = new BinaryTreeNode(
    { name: root.name, profile_picture: root.profile_picture },
    0,
    leftTree,
    rightTree,
  );
    ...
    return (
      <div className="flex flex-col items-center">
        <div className="flex flex-col items-center">
          <img
            src={
              node.value?.profile_picture
                ? `${BASE_URL}/media/${node.value.profile_picture}`
                : UserProfile
            }
            alt="profile"
    ...
    <div className="flex flex-col items-center">
      <div className="flex flex-col items-center">
        <div className="flex flex-col items-center">
          <img
            src={
              rootNode.value?.profile_picture
                ? `${BASE_URL}/media/${rootNode.value.profile_picture}`
                : UserProfile
            }
            alt="profile"
            className="w-20 h-20 rounded-full mb-2"
...
TreeNodeAdmin.propTypes = {
  members: PropTypes.array.isRequired,
  root: PropTypes.object,
};

export default TreeNodeAdmin;
